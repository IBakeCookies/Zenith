 ...
 * today look like as designed", so completing a task must not move it.
...
export interface RemainingDay {
	 ...
	 * executed counterpart to Human Capacity's planned saturation.
