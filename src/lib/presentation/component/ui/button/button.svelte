<script lang="ts" module>
	...
	export const buttonVariants = tv({
		...
		base: "focus-visible:border-ring focus-visible:ring-ring aria-invalid:ring-danger-line aria-invalid:border-destructive rounded-md border border-transparent bg-clip-padding text-sm font-medium focus-visible:ring-3 active:not-aria-[haspopup]:translate-y-px aria-invalid:ring-3 [&_svg:not([class*='size-'])]:size-4 group/button inline-flex shrink-0 items-center justify-center whitespace-nowrap transition-all outline-none select-none disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0",
		variants: {
			variant: {
				...
				destructive:
					'bg-destructive-soft hover:bg-destructive-soft-hover focus-visible:ring-danger-line text-destructive-foreground focus-visible:border-danger-line',
